...
class PointEService:
    def __init__(self, device=None, quality='high'):
        ...
        self.quality_presets = {
            ...
            'high': {'base_points': 2048, 'total_points': 8192, 'guidance_scale': 7.5, 'use_upsample': True},
            'ultra': {'base_points': 4096, 'total_points': 16384, 'guidance_scale': 10.0, 'use_upsample': True}
        }
